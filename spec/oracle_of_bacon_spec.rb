...
describe OracleOfBacon do
  ...
  describe 'instance', :skip => false do
  ...
  describe 'parsing XML response', :skip => false do
  ...
  describe 'constructing URI', :skip => false do
    subject do
  ...
  describe 'service connection', :skip => false do
    before(:each) do
